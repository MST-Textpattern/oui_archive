...
"oui_archive":https://github.com/NicolasGraph/oui_archive is a "oui_player":https://github.com/NicolasGraph/oui_player v2+ extension to easily embed "Archive":https://archive.org/ provided medias in "Textpattern":https://textpattern.com/ powered websites.
...
oui_archive's minimum requirements:
...
# "Download":https://github.com/NicolasGraph/oui_archive/releases the compiled plugin file or the source to compile a customized file.
...
oui_archive version 1.0.0-BETA2, Copyright (C) 2018 Nicolas Morand
...
* *oui_archive v1.0.0-BETA2* (2018-07-04)
